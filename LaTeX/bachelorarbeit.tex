...
\newcommand{\fullname}{Philipp Letschka}
\newcommand{\email}{philipp.letschka@uni-ulm.de}
\newcommand{\titel}{Enhancing BPMNGen with Prompting Strategies for Automated BPMN 2.0 Process Model Generation}
\newcommand{\jahr}{2025}
\newcommand{\matnr}{1050994}
\newcommand{\gutachterA}{Prof.\,Dr.\,Manfred Reichert }
\newcommand{\gutachterB}{Prof.\,Dr.\,Un Leserlich}
\newcommand{\betreuer}{Luca F. Hörner}
...
\newcommand{\institut}{Datenbanken und Informationssysteme}
...
\hyphenation{Dia-gramm-grö-ße}
\hyphenation{Mo-dell-ant-wor-ten}
\hyphenation{Prompt-In-put}
...
\input{chapters/codeoptimization}
