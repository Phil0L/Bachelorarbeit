...
Business Process Model and Notation (BPMN) ist ein beliebtes Werkzeug zur 
...
Die Diagramme werden nur einmalig erzeugt und können nur begrenzt interaktiv angepasst werden. 
Außerdem ist das Prompting sehr statisch aufgebaut, sodass die KI nicht auf 
...
Vergleichbare Text zu BPMN Bots erzeugen meist nur ein einziges Diagramm, ohne die Möglichkeit, 
...
Damit die KI bessere Ergebnisse liefern kann, braucht sie jedoch klare Anleitung und 
eine implementierung von modernen Prompting-Strategien. 
...
Techniken wie Chain of Thought oder Reflective Prompting sind entscheidend, indem sie der KI 
...
Datei-Uploads, Streaming, die Kombination von Text- und Diagrammausgaben sowie 
Techniken wie Reflective Prompting und Diagramm Sampling. 

Kapitel~4 untersucht die Performanz des erweiterten Systems. 
Dazu werden die erzeugten Diagramme auf ihre Qualität, im Hinblick auf Vollständigkeit, 
Konsistenz und Struktur, bewertet. 
Ausserdem wird die Geschwindigkeit,
