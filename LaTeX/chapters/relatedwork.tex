...
\paragraph{ProMoAI}
Es existieren auch andere änhliche Projekte welche Prozessmodelle mit Hilfe von
LLMs erstellen.
...
von Kourani et al.\ selber entwickelte Modellierungssprache POWL~\cite{kourani2023powl}, 
deren Struktur und klar definierte Operatoren dazu dient, sodass das LLM 
Prozessmodelle in einem gut überprüfbaren Format generiert.

\paragraph{AutoBPMN.AI}
Ein anderes Projekt ist AutoBPMN.AI
\footnote{\url{https://autobpmn.ai/}}
von Klievtsova et al.~\cite{klievtsova2015autobpmnai} an der Technischen Universität München.
Beim diesem Projekt steht auch die konversationelle Modellierung im 
Vordergrund.
...
Für die KI wir allerdings so wie auch bei BPMNGen ein anderes Format für die KI benutzt.
...
können. 
Hierbei ist das System sehr Änhlich wie der in dieser Arbeit verwendete Chain-of-tought
...
Ein zentrales Element bei LLM4PM die Integration unternehmensspezifischer Dokumentation, 
...
Zwischen beiden Projekten bestehen einige Parallelen. 
...
Ein wesentlicher Aspekt des BPMN-Chatbot++ sind die integrierten Model checking components
~\cite{koeppke2025BPMNChatbotPP, koeppke2025ERForum}. 
