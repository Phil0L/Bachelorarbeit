...
\begin{figure}[!htb]
  \centering
  \includegraphics[width=\textwidth]{images/diagrams/gemini-2.5-flash-(json)-vsaxxdmn}
  \caption{Diagramm von Gemini 2.5 Flash mit JSON}
...
\begin{figure}[!htb]
  ...
  \caption{Diagramm von Gemini 2.5 Flash mit XML}
  \label{fig:gemini-2-5-flash-xml}
\end{figure}

\begin{figure}[!htb]
  \centering
  \includegraphics[height=.95\textheight]{images/diagrams/gpt-5.2-(json)-0kqyads7}
  \caption{Diagramm von ChatGPT 5.2 mit JSON}
...
\begin{figure}[!htb]
  ...
  \caption{Diagramm von ChatGPT 5.2 mit XML}
  \label{fig:gpt-5-2-xml}
\end{figure}

\begin{figure}[!htb]
  \centering
  \includegraphics[width=\textwidth]{images/diagrams/gpt-5.1-(json)-e2u2x4zb}
...
\begin{figure}[!htb]
  \centering
  \includegraphics[height=.95\textheight]{images/diagrams/gpt-4.1-(json)-6xk6wtee}
  \caption{Diagramm von ChatGPT 4.1 mit JSON}
...
\begin{figure}[!htb]
  ...
  \caption{Diagramm von ChatGPT 4.1 mit XML}
...
\begin{figure}[!htb]
  \centering
  \includegraphics[height=.95\textheight]{images/diagrams/grok-4-(xml)-o3fefday}
...
\begin{figure}[!htb]
  ...
  \caption{Diagramm von Grok 4.1 Fast mit JSON}
  \label{fig:grok-4-1-json}
\end{figure}

\begin{figure}[!htb]
  \centering
  \includegraphics[height=.95\textheight]{images/diagrams/grok-4-1-fast-reasoning-(xml)-c0ivs3u9}
  \caption{Diagramm von Grok 4.1 Fast mit XML}
  \label{fig:grok-4-1-xml}
\end{figure}

\begin{figure}[!htb]
  \centering
  \includegraphics[height=.95\textheight]{images/diagrams/claude-opus-4-5-(json)-wkq3inzs}
...
\begin{figure}[!htb]
  \centering
  \includegraphics[height=.95\textheight]{images/diagrams/claude-sonnet-4-5-(json)-hy0axos0}
  \caption{Diagramm von Claude Sonnet 4.5 mit JSON}
